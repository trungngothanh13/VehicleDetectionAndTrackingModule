...
class VehicleModel:
    ...
    Uses Ultralytics YOLO26 with built-in BoT-SORT / ByteTrack trackers.
    """

    def __init__(self, model_name, target_classes, confidence_threshold, imgsz=640, tracker_type='botsort.yaml'):
    ...
    def track(self, frame):
        """
        Detect + track in one GPU pass using Ultralytics built-in tracker.
